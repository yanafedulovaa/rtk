...
После успешного запуска всех контейнеров через Docker проект будет доступен по следующему адресу:
```
http://localhost:3000/login | Frontend (веб-интерфейс) | Страница входа в систему
```
